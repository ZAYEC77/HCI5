                ...
                hitTest.Location == TreeViewHitTestLocations.StateImage))
            {
                ...
                try
                {
                            ...
                            out iContextMenuPtr, out iContextMenu))
                    {
                        ...
                        string topInvoke = hitTest.Node.IsExpanded ? "Çãîðíóòè" : "Ðîçãîðíóòè";
    ...
    internal class BrowserLVContextMenuWrapper : NativeWindow
    {
        ...
        private void CreateFolderMenu(Point ptInvoke, MouseEventArgs e)
        {
            ...
            try
            {
                ...
                ShellAPI.MENUITEMINFO itemInfo = new ShellAPI.MENUITEMINFO("Âèä");
                ...
                ShellAPI.AppendMenu(viewSubMenu, 
                    (br.CurrentViewPlugin == null && br.FileView.View == View.Tile ? rCheck : 0), (uint)CMD_CUSTOM.Tiles, "Ïëèòêè");
                ShellAPI.AppendMenu(viewSubMenu,
                    (br.CurrentViewPlugin == null && br.FileView.View == View.LargeIcon ? rCheck : 0), (uint)CMD_CUSTOM.Icons, "Ï³êòîãðàìè");
                ShellAPI.AppendMenu(viewSubMenu,
                    (br.CurrentViewPlugin == null && br.FileView.View == View.List ? rCheck : 0), (uint)CMD_CUSTOM.List, "Ñïèñîê");
                ShellAPI.AppendMenu(viewSubMenu,
                    (br.CurrentViewPlugin == null && br.FileView.View == View.Details ? rCheck : 0), (uint)CMD_CUSTOM.Details, "Äåòàëüíèé");
                ...
                ShellAPI.AppendMenu(contextMenu, canPaste ? 0 : ShellAPI.MFT.GRAYED, (int)CMD_CUSTOM.Paste, "Âñòàâèòè");
                ShellAPI.AppendMenu(contextMenu, canPasteShortCut ? 0 : ShellAPI.MFT.GRAYED, (int)CMD_CUSTOM.Paste_ShortCut, "Âñòàâèòè ÿðëèê");
                ...
                {
                    ShellAPI.AppendMenu(contextMenu, ShellAPI.MFT.SEPARATOR, 0, string.Empty);
                    ShellAPI.AppendMenu(contextMenu, 0, (int)CMD_CUSTOM.Properties, "Âëàñòèâîñò³");
                }
